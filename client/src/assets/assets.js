...
export const dummyCategories = [
    { _id: "1", name: "Music" },
    { _id: "2", name: "Sports" },
    { _id: "3", name: "Arts & Theatre" },
    { _id: "4", name: "Film" },
    { _id: "5", name: "Science & Tech" },
    { _id: "6", name: "Health & Wellness" },
    { _id: "7", name: "Business" },
    { _id: "8", name: "Food & Drink" },
]
...
export const dummyEvents = [
    {
        _id: "1",
        title: "Build a Production-Ready Raspberry Pi Pico 2 Device",
        date: "2026-02-21T22:00:00",
        location: "Geoffrey Bawa Space",
        price: 156.55,
    ...
    {
        _id: "5",
        title: "Culinary Arts Workshop: Gourmet Cooking",
